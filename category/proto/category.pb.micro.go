...
type CategoryService interface {
	...
	// 删
	DeleteCategory(ctx context.Context, in *DeleteCategoryRequest, opts ...client.CallOption) (*DeleteCatehoryResponse, error)
	//查
	...
	FidAllCategory(ctx context.Context, in *FindAllRequest, opts ...client.CallOption) (*FindAllResponse, error)
}
...
func (c *categoryService) DeleteCategory(ctx context.Context, in *DeleteCategoryRequest, opts ...client.CallOption) (*DeleteCatehoryResponse, error) {
	req := c.c.NewRequest(c.name, "Category.DeleteCategory", in)
	out := new(DeleteCatehoryResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *categoryService) FidAllCategory(ctx context.Context, in *FindAllRequest, opts ...client.CallOption) (*FindAllResponse, error) {
	req := c.c.NewRequest(c.name, "Category.FidAllCategory", in)
	out := new(FindAllResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type CategoryHandler interface {
	...
	// 删
	DeleteCategory(context.Context, *DeleteCategoryRequest, *DeleteCatehoryResponse) error
	//查
	...
	FidAllCategory(context.Context, *FindAllRequest, *FindAllResponse) error
}
...
func RegisterCategoryHandler(s server.Server, hdlr CategoryHandler, opts ...server.HandlerOption) error {
	type category interface {
		...
		DeleteCategory(ctx context.Context, in *DeleteCategoryRequest, out *DeleteCatehoryResponse) error
		...
		FidAllCategory(ctx context.Context, in *FindAllRequest, out *FindAllResponse) error
	}
...
func (h *categoryHandler) DeleteCategory(ctx context.Context, in *DeleteCategoryRequest, out *DeleteCatehoryResponse) error {
...
func (h *categoryHandler) FidAllCategory(ctx context.Context, in *FindAllRequest, out *FindAllResponse) error {
	return h.CategoryHandler.FidAllCategory(ctx, in, out)
}
