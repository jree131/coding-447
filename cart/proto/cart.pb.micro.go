...
type CartService interface {
	...
	DeleteById(ctx context.Context, in *CartID, opts ...client.CallOption) (*Response, error)
...
func (c *cartService) DeleteById(ctx context.Context, in *CartID, opts ...client.CallOption) (*Response, error) {
...
type CartHandler interface {
	...
	DeleteById(context.Context, *CartID, *Response) error
...
func RegisterCartHandler(s server.Server, hdlr CartHandler, opts ...server.HandlerOption) error {
	type cart interface {
		...
		DeleteById(ctx context.Context, in *CartID, out *Response) error
...
func (h *cartHandler) DeleteById(ctx context.Context, in *CartID, out *Response) error {
